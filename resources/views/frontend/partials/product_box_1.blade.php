<article class="swiper-slide product-layout swiper-slide-visible swiper-slide-next" style="">
        ...
        <div class="product-inner">
            <div class="product-image">
                ...
                <div class="action-links">
                    <a class="" href="#" onclick="showAddToCartModal({{ $product->id }})"  title="Add to Cart"><i class="fas fa-shopping-bag"></i></a>
